...
gamma_list = [0.01, 0.005, 0.002, 0.0005, 0.0001]
c_list = [0.1, 0.2, 0.5, 0.8, 1, 3, 5, 8, 10]
...
for i in range(len(predicted_lable_svm)):
 	if predicted_lable_svm[i] != predicted_labels_DecisionTree [i]:
         count=count+1
         print("Prediction is diffrent for Index",i)
print("Predicted lable were not matching with taken two classifier are",'=',count)
