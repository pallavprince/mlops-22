...
#     result_dataframe = pd.DataFrame(columns=['Gamma', 'C', 'train','dev','test'])
    ...
    data = {'Gamma':gamma_list,'C':c_list,'Training_Accuracy':train_list,'Dev_Accuracy':val_list,'Test_Accuracy':test_list}
    ...
    print("\n\n--")
    print("Dev_Accuracy")
    print("Dev  Accuracy min " , df['Dev_Accuracy'].min())
    print("Dev Accuracy mean " , df['Dev_Accuracy'].mean())
    print("Dev Accuracy max " , df['Dev_Accuracy'].min())
    print("Dev Accuracy median " , df['Dev_Accuracy'].median())
    print("\n\n---")
    print("Test Accuracy")
    ...
    print("\n\n---")
    print("Highest accuracy on Dev dataset is : {0} and corresponsing hyperparamter are {1}.".format(best_acc,com_hyper))
...
print("MLops Quiz 2 25 Sep 2022")
